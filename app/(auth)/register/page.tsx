...
import { CreditCard, Loader2, Eye, EyeOff, Check } from "lucide-react"
      ...
      <Card className="w-full max-w-md rounded-2xl border-border relative z-10">
        <CardHeader className="text-center space-y-4 pb-2">
          <Link href="/" className="inline-flex items-center justify-center gap-3 mx-auto">
            ...
            <span className="text-2xl font-bold text-foreground">Payment Platform</span>
          </Link>
          <div>
            <CardTitle className="text-xl">Create an account</CardTitle>
            <CardDescription>Get started with payment orchestration</CardDescription>
          </div>
        </CardHeader>
